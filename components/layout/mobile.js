  ...
  return (
    <div className="flex items-center">
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            className="fixed top-[80px] z-20 overflow-x-hidden left-0 right-0 dark:bg-primary bg-white overflow-y-auto min-h-screen  h-screen w-full dark:text-white text-primary flex flex-col pt-6  pb-24"
            initial={{ x: "-100%" }}
            animate={{ x: 0 }}
            exit={{ x: "-100%" }}
            transition={{
